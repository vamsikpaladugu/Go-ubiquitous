...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void syncWithWatch() {
        ...
        if (cursor.moveToFirst()) {
            ...
            PutDataMapRequest putDataMapReq = PutDataMapRequest.create(PATH_WEATHER);

            putDataMapReq.getDataMap().putString(KEY_TEMPHIGH, Utility.formatTemperature(getContext(), high));
            putDataMapReq.getDataMap().putString(KEY_TEMPLOW, Utility.formatTemperature(getContext(), low));
            putDataMapReq.getDataMap().putInt(KEY_WEATHERID, weatherId);
